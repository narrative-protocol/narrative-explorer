...
export function ChainBadge({ chain }: { chain: string }) {
  return (
    <Badge
      variant="outline"
      className="border-primary/30 bg-primary/5 text-primary font-mono text-xs"
    >
      {chain}
    </Badge>
  );
...
export function AttestationIndicator({
  hasAttestation,
  hasSolana,
  hasNear,
}: {
  ...
  return (
    <div className="flex items-center gap-1.5">
      ...
      {hasSolana && (
        <Badge
          variant="outline"
          className="h-5 border-chart-1/40 bg-chart-1/10 px-1.5 text-[10px] font-mono text-chart-1"
        >
          SOL
        </Badge>
      )}
      {hasNear && (
        <Badge
          variant="outline"
          className="h-5 border-chart-2/40 bg-chart-2/10 px-1.5 text-[10px] font-mono text-chart-2"
        >
          NEAR
        </Badge>
      )}
...
export function StatCard({
  ...
  return (
    <div className="rounded-lg border border-border bg-card p-4">
      ...
      <p className="mt-2 text-2xl font-bold text-primary font-mono">
...
export function JsonBlock({ data }: { data: unknown }) {
  ...
  return (
    <div className="scrollbar-custom overflow-x-auto rounded-md bg-secondary">
      <SyntaxHighlighter
        language="json"
        style={vscDarkPlus}
        customStyle={{
